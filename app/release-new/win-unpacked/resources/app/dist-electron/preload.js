...
const api = {
    ...
    saveDeviceConfig: (deviceId, config) => ipcRenderer.invoke('save-device-config', deviceId, config),
    loadDeviceConfig: (deviceId) => ipcRenderer.invoke('load-device-config', deviceId),
    // Hotkey execution
    executeHotkey: (hotkeyString, holdDuration) => ipcRenderer.invoke('execute-hotkey', hotkeyString, holdDuration),
    // Window controls
